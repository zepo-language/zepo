...
;; Import math/tensor BEFORE math/stats: math/stats pulls in math/linear, which
;; also exports `transpose`, so the import order decides which unqualified
;; `transpose` wins. Tensor-first makes it resolve to the tensor version.
(import math/tensor)
(import math/stats)
(import math/dist)
